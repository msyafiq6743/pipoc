<?php
    if (isset($_POST['day_1'])) {
        ...
        class PDF extends FPDF
            ...
            // Page header
                function Header()
                {
                    ...
                    // $this->Cell(80);
                    // Title
                    $this->Cell(0,0,'Registration Record PIPOC 2021 Day 1',0,0,'C');
                    // Line break
                    $this->Ln(10);
                }
            }
        ...
        $pdf->Output('D','Registration Record PIPOC 2021 Day 1.pdf');
    }

    else if (isset($_POST['day_2'])) {
        ...
        class PDF extends FPDF
            ...
            // Page header
                function Header()
                {
                    ...
                    // $this->Cell(80);
                    // Title
                    $this->Cell(0,0,'Registration Record PIPOC 2021 Day 2',0,0,'C');
                    // Line break
                    $this->Ln(10);
                }
            }
        ...
        $pdf->Output('D','Registration Record PIPOC 2021 Day 2.pdf');

    }
    else if (isset($_POST['day_3'])) {
        ...
        class PDF extends FPDF
            ...
            // Page header
                function Header()
                {
                    ...
                    // $this->Cell(80);
                    // Title
                    $this->Cell(0,0,'Registration Record PIPOC 2021 Day 3',0,0,'C');
                    // Line break
                    $this->Ln(10);
                }
            }
        ...
        $pdf->Output('D','Registration Record PIPOC 2021 Day 3.pdf');
